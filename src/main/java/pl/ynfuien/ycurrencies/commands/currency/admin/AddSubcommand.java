...
public class AddSubcommand implements Subcommand {
    ...
    public AddSubcommand(Currency currency, Subcommand command) {
    ...
    public String description() {
        return lang.get(Lang.Currency.COMMAND_ADMIN_ADD_DESCRIPTION);
    }
    ...
    public void run(CommandSender sender, Command command, String label, String[] args) {
        ...
        lang.send(sender, Lang.Currency.COMMAND_ADMIN_ADD, placeholders);
    }
